<?php
$string['about_tbs']         = 'About TBS';
$string['accessdenied']       = 'Access Denied';
$string['accesstbs'] = 'Schedule a resource';
$string['addarea']            = 'Add Area';
$string['addentry']           = 'Add Entry';
$string['addroom']            = 'Add Class';
$string['adminview'] = 'What is URL to your TBS Install?';
...
$string['blockname'] = 'Test Scheduling';
$string['booking_users'] = 'Users who can book';
$string['booking_users_help'] = "This should be a comma-separated list of the email addresses of the users who are allowed to book this class. Leave this blank to allow all users to book this class.";
$string['bookingmoved']        = 'One of your bookings has been moved';
$string['bookingmovedmessage']        = 'Your {$a->name} booking has been moved from Class {$a->oldclass} to Class {$a->newclass} in {$a->area} for the lesson on {$a->date}, {$a->starttime}. The class is required for {$a->newbookingname}. WARNING: this move has been done by a computer making a calculated best guess, please check that the class is suitable before the lesson';
$string['bookingmovedshort']        = '{$a->name} moved to {$a->newclass}';
...
$string['clash']            = 'Clash: {$a->oldbooking} {$a->newbooking} {$a->time} in Class: {$a->class}';
$string['clashemailbody']            = 'Due to a recent timetable import, there is a clash involving one of your bookings: On {$a->time}, {$a->oldbooking} and {$a->newbooking} are both booked into class {$a->class} Please resolve this between yourselves in advance to avoid unnecessary disruption. THIS WILL BE YOUR ONLY WARNING OF THIS CLASH. IF YOU IGNORE THIS E-MAIL YOU WILL HAVE PROBLEMS. This message has been sent automatically by the online class booking system, if you think you have recieved this in error please contact {$a->admin}';
$string['clashemailnotsent']            = 'COULDN\'T SEND EMAIL TO TEACHER OF ';
$string['clashemailsent']            = 'email sent to';
$string['clashemailsub']            = 'Class Clash Alert';
$string['room']            = 'class';
$string['click_to_reserve']   = 'Click on the cell to make a reservation.';
$string['computerroom'] = 'Computer classs only';
$string['computerrooms'] = 'Computer Classs';
$string['config_admin_email'] = 'TBS admin email';
$string['config_admin_email2'] = 'Email address of the TBS administrator. In order to receive TBS email notifications, the email address must be associated with a Moodle user account.';
$string['config_admin'] = 'TBS Admin';
$string['config_admin2'] = 'Name of the TBS administrator';
...
$string['config_dateformat2']  = 'Date format to be used by TBS.';
$string['config_default_report_days'] = 'Report span (days)';
$string['config_default_report_days2'] = 'Default report span in days';
$string['config_default_room'] = 'Default class';
$string['config_default_room2'] = 'Define default class to start with (used by index.php). Class numbers can be determined by looking at the Edit or Delete URL for a class on the admin page.';
...
$string['config_enable_periods2'] = 'Use custom periods for TBS scheduling.  If this is set to no then TBS will schedule using time blocks';
...
$string['config_mail_room_admin_on_bookings'] = 'Mail class admin';
$string['config_mail_room_admin_on_bookings2'] = 'Send email to class admin notifying of a new booking';
...
$string['config_max_advance_days2'] = 'The maximum days in advance you can make a booking (-1) to disable. Users with capability \'tbs:ignoremaxadvancedays\' (by default, site or tbs admins) will still be able to make bookings further in advance than this.';
...
$string['config_new_window2'] = 'When set to New window, the TBS block will open in a new window. When set to Same window, the TBS block will open inside of Moodle with the Moodle headers.';
...
$string['config_timeformat2']  = 'Time format to be used by TBS.';
...
$string['ctrl_click']         = 'Use Control-Click to select more than one class';
...
$string['delarea']            = 'You must delete all classs in this area before you can delete it<p>';
...
$string['dontshowoccupied']   = 'Don\'t show occupied classs';
$string['doublebookebody']    = 'The user {$a->user} has double booked your class, {$a->class}, at {$a->time} on {$a->date}. This clashes with your booking for {$a->oldbooking}. The user has booked the class for {$a->newbooking}. If this is not a problem, no action is required. However, if you weren\'t expecting this, please contact the user to resolve the conflict. This message has been sent automatically by the online class booking system, if you think you have recieved this in error please contact {$a->admin}';
...
$string['editroom']           = 'Edit Class';
$string['editroomarea']       = 'Edit Area or Class Description';
...
$string['forciblybook'] = 'Forcibly book a class';
...
$string['mail_subject_entry'] = 'Entry changed for {$a->date}, {$a->class} (by {$a->user})';
$string['mail_subject_delete'] = 'Entry deleted for {$a->date}, {$a->class} (booked by {$a->user})';
$string['mail_subject_newentry'] = 'Entry added for {$a->date}, {$a->class} (by {$a->user})';
$string['match_area']         = 'Match area';
$string['match_descr']        = 'Match full description';
$string['match_entry']        = 'Match brief description';
$string['match_room']         = 'Match class';
...
$string['tbs:addinstance'] = 'Add TBS block to My Moodle page';
$string['tbs:administertbs'] = 'Modify TBS classs + settings';
$string['tbs:edittbs'] = 'Edit TBS bookings';
$string['tbs:doublebook'] = 'Double Book Classs';
$string['tbs:edittbsunconfirmed'] = 'Only create \'unconfirmed\' bookings (overriden by \'edittbs\')';
$string['tbs:forcebook'] = 'Force Book Classs (auto move existing bookings)';
$string['tbs:ignoremaxadvancedays'] = 'Ignore the \'max_advance_days\' setting';
$string['tbs:myaddinstance'] = 'Add new TBS block';
$string['tbs:viewalltt'] = 'View All Users\' Timetables';
$string['tbs:viewtbs'] = 'View TBS bookings';
$string['tbs']               = 'Meeting Class Booking System';
$string['tbsadmin'] = 'TBS administrator';
$string['tbsadmin_desc'] = 'Users with this role (at the system level) can fully configure an TBS timetable: create areas and classs, edit other people\'s bookings, force bookings and double-book classs';
$string['tbseditor'] = 'TBS editor';
$string['tbseditor_desc'] = 'Users with this role (at the system level) can make bookings using TBS and edit their own bookings';
$string['tbsviewer'] = 'TBS viewer';
$string['tbsviewer_desc'] = 'Users with this role (at the system level) can view the TBS timetable, but cannot make any changes';
$string['mustlogin'] = 'You must be logged in to Moodle before you can access the TBS calendar block';
...
$string['no_rooms_for_area']  = 'No classs defined for this area';
$string['no_user_with_email'] = 'No Moodle users found with an email address of: {$a}. All TBS related email(s) must be associated with a Moodle user account.';
...
$string['norooms']            = 'No classs.';
$string['noroomsfound']            = 'Sorry, no classs found';
...
$string['notallowedbook']     = 'You are not in the list of users allowed to book this class';
$string['of']                 = ' of ';
...
$string['requestvacatemessage']= '{$a->user} requests that you move {$a->description} from class {$a->class}, {$a->datetime}. Please contact them to discuss this.[Give a reason]';
$string['requestvacatemessage_html']= '{$a->user} requests that you move <a href="{$a->href}">{$a->description}</a> from class {$a->class}, {$a->datetime}. Please contact them to discuss this.<br /><br />[Give a reason]';
$string['resolution_units'] = ' Minutes';
$string['returncal']          = 'Return to calendar view';
$string['returnprev']         = 'Return to previous page';
$string['rights']             = 'Rights';
$string['room_admin_email']   = 'Class admin email';
$string['room']               = 'Class';
$string['roomchange']         = 'Mark as class change';
$string['rooms']              = 'Classs';
$string['roomsearch']              = 'Class Search';
$string['roomsfree']              = 'Classs free...';
$string['sched_conflict']     = 'Scheduling Conflict';
$string['search_for']         = 'Search For';
$string['search_results']     = 'Search Results for';
$string['seconds']            = 'seconds';
$string['serverpath'] = 'TBS Installation path';
...
$string['specialclass'] = 'Exclude special classs';
...
$string['teachingroom'] = 'Teaching classs only';
...
$string['toofaradvance']      = 'You cannot book classs more than {$a} days in advance';
...
$string['update_room_failed'] = 'Update class failed';
$string['useful_n-weekly_value'] = 'useful n-weekly value.';
$string['valid_room']         = 'class.';
