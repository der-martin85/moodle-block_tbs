...
/**
 * Strings for component 'block_tbs', language 'de', branch 'MOODLE_31_STABLE'
 *
 * @package   block_tbs
...
$string['about_tbs'] = 'Über tbs';
$string['accessdenied'] = 'Zugang verweigert';
$string['accesstbs'] = 'Ressourcen verwalten';
$string['addarea'] = 'Bereich hinzufügen';
$string['addentry'] = 'Eintrag hinzufügen';
$string['addroom'] = 'Klasse hinzufügen';
$string['adminview'] = 'Über welche URL wird das Buchungssystem tbs aufgerufen?';
$string['advanced_search'] = 'Erweiterte Suche';
$string['all_day'] = 'Ganztägig';
$string['area'] = 'Bereich';
$string['area_admin_email'] = 'E-Mail Jahrgangsadmin';
$string['areas'] = 'Jahrgänge';
$string['backadmin'] = 'Zurück zu Admin';
$string['bgcolor'] = 'Färbung';
$string['blockname'] = 'Klassenarbeiten';
...
$string['capacity'] = 'Wochenanzahl';
$string['charset'] = 'UTF-8';
$string['clash'] = 'Konflikt: {$a->oldbooking} {$a->newbooking} {$a->time} mit Klasse: {$a->room}';
...
$string['config_admin2'] = 'Name des tbs-Administrators';
$string['config_admin_email'] = 'E-Mail tbs Admin';
$string['config_admin_email2'] = 'E-Mail-Adresse des tbs-Administrators';
$string['config_area_list_format'] = 'Anzeige der Jahrgänge';
$string['config_area_list_format2'] = 'Sollen Jahrgänge als Liste (Auflisten) oder Auswahlbox (Auswählen) angezeigt werden?';
...
$string['config_default_room'] = 'Standard Jahrgang';
$string['config_default_room2'] = 'Standardmäßig wird diese Klasse beim Aufruf des Buchungssystems gezeigt. Die Klassennummer lässt sich über den Link auf die Klasse herausfinden.';
...
$string['config_mail_area_admin_on_bookings'] = 'E-Mail an Jahrgangsadmin';
$string['config_mail_area_admin_on_bookings2'] = 'Der Jahrgangsadmin wird per E-Mail über neue Buchungen in seinem Bereich informiert.';
...
$string['config_mail_from2'] = 'Diese Absenderadresse wird in ausgehende E-Mails eingetragen. Standardmäßig ist es die E-Mail-Adresse des tbs-Admins. Der Absender muss ein Moodlekonto haben.';
...
$string['config_mail_room_admin_on_bookings2'] = 'Der Klassenadmin wird per E-Mail über neue Buchungen seiner Klasse informiert.';
...
$string['config_new_window2'] = 'Wenn \'Neues Fenster\' ausgewählt ist, dann wird das Buchungssystem tbs in einem neuem Fenster geöffnet. Wenn \'Gleiches Fenster\' gewählt ist, dann wird das Buchungssystem tbs im gleichen Fenster geöffnet - innerhalb von Moodle mit Navigationsleiste.';
...
$string['config_resolution2'] = 'tbs erzeugt ein gleichmäßiges Zeitraster. Die Option \'Eigene Zeittafel\' ist deaktiviert.';
...
$string['days'] = 'Tage';
$string['delarea'] = 'Sie müssen alle Klassen im Jahrgang löschen, bevor Sie den Jahrgang löschen können<p>';
...
$string['dontshowoccupied'] = 'Belegte Klassen nicht anzeigen';
...
$string['editarea'] = 'Jahrgang bearbeiten';
...
$string['editroom'] = 'Klasse bearbeiten';
$string['editroomarea'] = 'Klassen- oder Jahrgangsbeschreibung bearbeiten';
...
$string['error_area'] = 'Fehler: Jahrgang';
$string['error_room'] = 'Fehler: Klasse';
...
$string['match_room'] = 'Suche Klasse:';
...
$string['tbs'] = 'Klassenarbeiten';
$string['tbs:addinstance'] = 'Neuen Block \'tbs\' für \'Meine Startseite\' hinzufügen';
$string['tbsadmin'] = 'tbs Admin';
$string['tbsadmin_desc'] = 'Nutzer/innen mit dieser globalen Rolle können das Buchungssystem tbs verwalten, Jahrgänge und Klassen anlegen, Buchungen aller Personen ändern, Buchungen erzwingen und Doppelbuchungen vornehmen.';
$string['tbs:administertbs'] = 'Zugriff tbs (lesen / schreiben / admin)';
$string['tbs:doublebook'] = 'Doppelbuchungen vornehmen';
$string['tbs:edittbs'] = 'Zugriff tbs (lesen / schreiben)';
$string['tbs:edittbsunconfirmed'] = 'Only create \'unconfirmed\' bookings (overriden by \'edittbs\')';
$string['tbseditor'] = 'tbs Editor';
$string['tbseditor_desc'] = 'Nutzer/innen mit dieser globalen Rolle können das Buchungssystem tbs benutzen, eigene Buchungen vornehmen, ändern und löschen, außerdem alle Buchungen sehen.';
$string['tbs:forcebook'] = 'Buchungen überschreiben (vorherige Buchungen automatisch verschieben)';
$string['tbs:myaddinstance'] = 'Neuen Block \'tbs\' hinzufügen';
$string['tbs:viewalltt'] = 'Alle Buchungen sehen';
$string['tbsviewer'] = 'tbs Viewer';
$string['tbsviewer_desc'] = 'Nutzer/innen mit dieser globalen Rolle können das Buchungssystem tbs nur sehen, aber keine Änderungen vornehmen.';
$string['tbs:viewtbs'] = 'Zugriff tbs (nur lesen)';
...
$string['noarea'] = 'Kein Jahrgang ausgewählt';
$string['noareas'] = 'Keine Jahrgänge';
$string['norights'] = 'Sie dürfen diesen Eintrag nicht ändern!';
$string['norooms'] = 'Keine Klassen vorhanden';
$string['no_rooms_for_area'] = 'Der Jahrgang enthält keine Klassen';
$string['noroomsfound'] = 'Keine Klasse gefunden';
$string['notallcreated'] = 'Einige Buchungen liegen zu weit im voraus. Es wurden {$a->created} von {$a->requested} Buchungen eingetragen.';
$string['notallowedbook'] = 'Sie stehen nicht in der Liste der Personen, die diese Klassee buchen dürfen.';
...
$string['pluginname'] = 'Klassenarbeiten';
...
$string['requestvacate'] = 'Anfrage ob diese Klasse umgebucht werden kann';
$string['requestvacatemessage'] = '{$a->user} möchte, dass Sie die Klasse freigeben ({$a->room}, {$a->datetime}, {$a->description}). Bitte nehmen Sie Kontakt auf.

[Begründung angeben]';
$string['requestvacatemessage_html'] = '{$a->user} möchte, dass Sie die Klasse freigeben ({$a->room}, {$a->datetime}, {$a->description}). Bitte nehmen Sie Kontakt auf. <br /><br />[Begründung angeben]';
...
$string['room'] = 'Klasse';
$string['room_admin_email'] = 'E-Mail Klassenadmin';
$string['roomchange'] = 'Als Änderung markieren';
$string['rooms'] = 'Klassen';
$string['roomsearch'] = 'Klasse';
$string['roomsfree'] = 'Klasse frei...';
...
$string['specialroom'] = 'Spezielle Klassen ausklammern';
...
$string['through'] = 'bis';
$string['toofaradvance'] = 'Sie können Klassen nicht mehr als {$a} Tage im voraus buchen.';
...
$string['update_area_failed'] = 'Jahrgangsänderung fehlgeschlagen:';
$string['update_room_failed'] = 'Klassenänderung fehlgeschlagen:';
$string['useful_n-weekly_value'] = 'Wert für n-wöchentlich';
$string['valid_room'] = 'Klasse.';
