...
$thisurl = new moodle_url('/blocks/tbs/web/add.php', array('type' => $type, 'name' => $name));
...
if ($type == "area") {
    ...
    $area = $DB->insert_record('block_tbs_area', $newarea);
}
...
if ($type == "room") {
    ...
    $DB->insert_record('block_tbs_room', $newroom);
}

redirect(new moodle_url('/blocks/tbs/web/admin.php', array('area' => $area)));
